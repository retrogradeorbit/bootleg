...
```shell
$ tar xvf bootleg-0.1.3-linux-amd64.tgz
$ mv bootleg ~/bin
```
...
```shell
$ curl -LO https://github.com/retrogradeorbit/bootleg/releases/download/v0.1.3/bootleg-0.1.3-linux-amd64.tgz
$ tar xvf bootleg-0.1.3-linux-amd64.tgz
